...
import org.tama.tamaapi.dto.requestDto.item.save.SaveReviewRequest;
import org.tama.tamaapi.command.item.ReviewRepository;
...
public class ReviewApiController {
    ...
    public ResponseEntity<SimpleResponse> saveReview(@Valid @RequestBody SaveReviewRequest saveReviewRequest, @AuthenticationPrincipal Long memberId) {
        Long orderMemberId = orderFeignClient.getOrderItemMember(saveReviewRequest.getOrderItemId());
        if(!Objects.equals(orderMemberId, memberId))
        ...
        */
        ...
        Review newReview = new Review(saveReviewRequest.getOrderItemId(), memberId, saveReviewRequest.getRating(), saveReviewRequest.getComment(),
