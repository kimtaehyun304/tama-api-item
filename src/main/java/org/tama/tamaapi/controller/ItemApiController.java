...
import org.tama.sharelib.common.dto.CustomPage;
...
import org.tama.tamaapi.dto.requestDto.CategoryItemFilterRequest;

import org.tama.tamaapi.dto.requestDto.item.save.SaveColorItemRequest;

import org.tama.tamaapi.dto.requestDto.item.save.SaveItemRequest;
import org.tama.tamaapi.dto.requestDto.item.save.SaveSizeStockRequest;

import org.tama.tamaapi.dto.responseDto.item.ColorItemDetailDto;
import org.tama.tamaapi.dto.responseDto.item.RelatedColorItemDto;


import org.tama.tamaapi.dto.responseDto.item.SavedColorItemIdResponse;
import org.tama.tamaapi.dto.responseDto.item.ShoppingBagDto;
import org.tama.tamaapi.event.ItemEventProducer;

import org.tama.tamaapi.query.item.dynamicQuery.ItemDynamicQueryRepository;
import org.tama.tamaapi.query.item.dynamicQuery.dto.CategoryItemQueryDto;
...
import org.tama.tamaapi.query.item.*;
...
public class ItemApiController {
    ...
    public CustomPage<CategoryItemQueryDto> categoryItem(@RequestParam(required = false) Long categoryId, @Valid CustomPageRequest customPageRequest
        ...
        if (itemFilter.getMinPrice() != null && itemFilter.getMaxPrice() != null && itemFilter.getMinPrice() > itemFilter.getMaxPrice())
            throw new IllegalArgumentException("최소값을 최대값보다 크게 입력했습니다.");
